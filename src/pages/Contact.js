    ...
    <motion.section 
      ...
      <div className='container mx-auto h-full'>
         ...
         lg:text-left'>
          ...
          left-0 right-0 top-72 -z-10'></motion.div>
          <div className='lg:flex-1 lg:pt-32 px-4'>
            ...
            <form className='flex flex-col gap-y-4'>
              <div className='flex gap-x-10'>
                ...
                font-secondary w-full pl-3' type='text' placeholder='Your name'/>
                <input className='outline-none border-b
                border-b-primary h-[60px] bg-transparent
                font-secondary w-full pl-3' type='text' placeholder='Your email address'/>
              </div>
              <input className='outline-none border-b
                border-b-primary h-[60px] bg-transparent
                font-secondary w-full pl-3' type='text' placeholder='Your message'/>
